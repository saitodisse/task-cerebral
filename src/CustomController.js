...
Factory.Mixin = {
  ...
  _update: function (state) {
    ...
    var newStateResult = Object.keys(statePaths).reduce(function (newState, key) {
      newState[key] = Value(statePaths[key], state);
      return newState;
    }, {});
    this.setState(newStateResult);
  }
};
...
var Render = function (Component) {
  return function () {
    ...
    var propsToPass = Object.keys(state).reduce(function (propsItem, key) {
      propsItem[key] = state[key];
      return propsItem;
    }, {});

    propsToPass = Object.keys(props).reduce(function (propsToPassItem, key) {
      propsToPassItem[key] = props[key];
      return propsToPassItem;
    }, propsToPass);
